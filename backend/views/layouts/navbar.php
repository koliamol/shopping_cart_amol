        ...
        */ ?>
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="d-none d-md-inline"><?= isset(Yii::$app->user->identity->email) ? Yii::$app->user->identity->email : 'Guest';?></span>
            </a>
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-header bg-primary">
                    ...
                    <p>
                    <?= isset(Yii::$app->user->identity->email) ? Yii::$app->user->identity->email : 'Guest';?>
                    </p>
                </li>
                
                <li class="user-footer">
                    <a href="#" class="btn btn-default btn-flat">Profile</a>
                    <?= Html::a('Sign out', ['/admin/user/logout'], ['data-method' => 'post', 'class' => 'btn btn-default btn-flat float-right']) ?>
                </li>
            </ul>
        </li>
        <?php /*
